...
#     be_success = finetune_biencoder(df_golden)  # Pass df_golden directly
#     ce_success = finetune_crossencoder(df_golden)  # Pass df_golden directly
...
def main():
    ...
    if model_type == "crossencoder":
        df_labeled = cross_encoder_predict()
    elif model_type == "biencoder":
        df_labeled = bi_encoder_predict()
    else:
